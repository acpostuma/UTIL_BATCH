...
inputFile="/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_BATCH/InputRunLists/KaonLT_2018_2019/helicity/${RunList}"
...
while true; do
    ...
    case $yn in
		...
		#echo "TIME: 1" >> ${batch} 
		echo "COMMAND:/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_BATCH/Analysis_Scripts/FullReplay_KaonLT_Helicity.sh ${runNum}" >> ${batch}
